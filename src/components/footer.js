      ...
      <footer className='footer-class'>
        ...
        <blockquote className='thirukural-container'>
          <div className='inTamil thirukural-body'>
            ...
            <div>&nbsp;</div>
            <div className='margin1'>அடைவதற்கு அரியதை அடைவதற்கு ஏற்ற காலம் வந்து விட்டால்</div>
            <div>அப்பொழுதே தான் செய்வதற்கு அரிய செயல்களைச் செய்து கொள்க.</div>
          </div>
        ...
        <Card.Meta className='copyright' textAlign='center'>
          Copyright 2018 - Trexvis India - All Rights Reserved.
        </Card.Meta>
      </footer>
    );
  }
